        ...
        <div className="h-full w-full px-8 bg-teal-100/20 py-4">
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="p-4 flex gap-5 items-center justify-center col-span-2">
                    <Card name="Total Quizzes" value={quizzes.length} />
                    <Card name="Total Users" value={users?.length}/>
                    <Card name="Total Questions" value="20" />
                    <Card name="Active users" value={activeUsers?.length} />
                </div>
